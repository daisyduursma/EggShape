...
#completeness index
ChaoR<-raster("/Users/daisy/Google Drive/PhD/ThermalStress/data/CmpltDomeCupGridCells100km2017-02-14.asc")
ChoaR<-trim(ChaoR)
...
ausOutline <- readShapeSpatial("/Users/daisy/Google Drive/PhD/Data/Spatial/AustraliaMask/AustraliaMask.shp", proj4string = CRS("+proj=longlat +datum=WGS84 +ellps=WGS84"))
ausOutline <-spTransform(ausOutline, CRS=CRS(paste(Albers)))


pdf(file = paste0("/Users/daisy/Google Drive/PhD/ThermalStress/figures/manuscript/Figure_1_SpeciesRichenss",as.Date(Sys.time()),".pdf"),
    width = 3.24, height = 3)

plot(RichAllSPecies,col=rgb.palette(9),legend=FALSE, axes=FALSE,box=FALSE)
plot(ausOutline, bg="transparent", add=TRUE,border="grey40")
plot(RichAllSPecies,
     legend.only=T,
     col=rgb.palette(9),
...
######################
#get shapefile of australia
shp = readShapeSpatial("/Users/daisy/Google Drive/PhD/Data/Spatial/AustraliaMask/AustraliaMask.shp")
...
plot(shp, bg="transparent", add=TRUE,border="grey40")
plot(elongDomed,
     legend.only=T,
     col=rgb.palette(9),
     smallplot=c(0.18,0.22, 0.2,0.33),
